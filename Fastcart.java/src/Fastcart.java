...
public class Fastcart {
  ...
  Fastcart(){
    ...
    *****************************************************************************************/
    ...
    panel2.setBounds(220,10,210,120);
    panel2.setBackground(Color.lightGray);
    JLabel l2;
    l2=new JLabel("Select Category :");
    l2.setBounds(20,20,120,20);
    l2.setFont(new Font("Serif", Font.BOLD, 16));
    JComboBox<String> category=new JComboBox<String>();
    category.setBounds(20,50,150,50);
    category.addItem("Mobile and Tablets");
    category.addItem("Computers");category.addItem("Electronics");
    ...
    *****************************************************************************************/
    ...
    panel3.setBounds(440,10,510,120);
    ...
    priceRB.setBounds(20,30,100,30);

    JRadioButton WarrantyRB = new JRadioButton("Warranty");
    WarrantyRB.setBounds(130,30,100,30);
    JRadioButton NoneRB = new JRadioButton("None");
    NoneRB.setBounds(240,30,100,30);
...
//*********
    ...
    *****************************************************************************************/
    ...
    panel5.setBounds(270,140,680,250);
...
itemlist.addListSelectionListener(new ListSelectionListener(){
	public void valueChanged(ListSelectionEvent v)
	{
        ...
        try{ Class.forName("com.mysql.cj.jdbc.Driver");
           Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/shopping","root","lenovoroot") ;           
           Statement s2 = con.createStatement();
           ResultSet rs1 = s2.executeQuery(q);
           rs1.next();
           {
        	   code.setText(rs1.getString(1));
               ...
               qtys.setText(rs1.getString(6));
               warranty.setText("" + rs1.getString(7) + " years");
           }
           rs1.close();
           //con.close();
           s2.close();
...
buycb.addItemListener(new ItemListener()
{
    ...
    *****************************************************************************************/
    ...
    panel6.setBounds(10,400,940,230);
...
scr2.setViewportView(Items);
    ...
    *****************************************************************************************/
    ...
    panel7.setBounds(10,640,940,70);
    JLabel l22;
    JTextField finalamt;
...
b.addActionListener(new ActionListener()
    {
         public void actionPerformed(ActionEvent e)
         {
DefaultListModel<String> m1 =  (DefaultListModel<String>) itemlist.getModel();
	...
	int am = Integer.parseInt(finalamt.getText());
        ...
        {  
           ...
           //String d,e,q;
            for(int m=0 ; m < dtm.getRowCount() ; m++ )
            { 
            	//System.out.println(dtm.getValueAt(m,0).toString());
            	//String d = (String) dtm.getValueAt(m,0);
              //e = dtm.getValueAt(m,3).toString();
             String q = "update fastcart set qty = qty - "+ dtm.getValueAt(m,3).toString() +" where Icode = '"+ dtm.getValueAt(m,0).toString() +"' ;";
